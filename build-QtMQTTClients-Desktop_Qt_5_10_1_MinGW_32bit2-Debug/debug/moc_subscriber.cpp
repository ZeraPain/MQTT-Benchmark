...
#include "../../QtMQTTClients/subscriber.h"
...
QT_MOC_LITERAL(4, 33, 14), // "QMqttTopicName"
QT_MOC_LITERAL(5, 48, 5), // "topic"
QT_MOC_LITERAL(6, 54, 12), // "stateChanged"
QT_MOC_LITERAL(7, 67, 11), // "ClientState"
QT_MOC_LITERAL(8, 79, 5), // "state"
QT_MOC_LITERAL(9, 85, 12), // "errorChanged"
QT_MOC_LITERAL(10, 98, 11), // "ClientError"
QT_MOC_LITERAL(11, 110, 5) // "error"

    },
    "Subscriber\0printMessage\0\0message\0"
    "QMqttTopicName\0topic\0stateChanged\0"
    "ClientState\0state\0errorChanged\0"
    "ClientError\0error"
};
...
void Subscriber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->printMessage((*reinterpret_cast< const QByteArray(*)>(_a[1])),(*reinterpret_cast< const QMqttTopicName(*)>(_a[2]))); break;
        case 1: _t->stateChanged((*reinterpret_cast< ClientState(*)>(_a[1]))); break;
        case 2: _t->errorChanged((*reinterpret_cast< ClientError(*)>(_a[1]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject Subscriber::staticMetaObject = {
    { &QMqttClient::staticMetaObject, qt_meta_stringdata_Subscriber.data,
